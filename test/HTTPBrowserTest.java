...
@RunWith(JUnit4.class)
  public class HTTPBrowserTest {
    ...
    public void testParseRequest() {
      browser.request = "GET /index.html HTTP/1.0";
      browser.parseRequest();
    ...
    public void testParseRouteWithNoQuestionMark() {
      ...
      assertArrayEquals(browser.parseRoute(routeString), expectedResult);
    }
    ...
    public void testBodyWithQueryString() {
      ...
      assertArrayEquals(browser.parseQueryString(queryString), expectedResult);
    }
